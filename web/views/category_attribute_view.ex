defmodule Nexpo.CategoryAttributeView do
  ...
  def render("index.json", %{category_attributes: category_attributes}) do
    %{data: render_many(category_attributes, Nexpo.CategoryAttributeView, "category_attribute.json")}
  end

  def render("show.json", %{category_attribute: category_attribute}) do
    %{data: render_one(category_attribute, Nexpo.CategoryAttributesView, "category_attribute.json")}
  end
