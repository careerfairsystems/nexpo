...
describe('Company', () => {
  ...
  it('should render without crashing', () => {
    ...
    shallow(<Company id="1" {...props} company={company} />);
  });

  it('should render loading while fetching ', () => {
    const wrapper = shallow(<Company id="1" {...props} fetching />);
  ...
  it('should set html title', () => {
    ...
    const wrapper = shallow(<Company id="1" {...props} company={company} />);
  ...
  it('should set edit mode if url contains #edit', () => {
    ...
    const wrapper = shallow(
      <Company id="1" {...props} company={company} location={location} />
    );
