...
describe("forgot_password", () => {
  it("should call request and success", () => {
    ...
    expect.assertions(1)
    return store.dispatch(Actions.accounts.forgot_password({}))
    .then(() => {
...
describe("verify_forgot_password_key", () => {
  it("should call request and success on success", () => {
    ...
    return store.dispatch(Actions.accounts.verify_forgot_password_key(params))
    .then(res => {
      const calledActions = store.getActions()
      expect(calledActions).toEqual(expectedActions)
    })
...
describe("replace_forgotten_password", () => {
  it("should call request and success on http success", () => {
    ...
    return store.dispatch(Actions.accounts.replace_forgotten_password(params))
    .then(() => {
      const calledActions = store.getActions()
