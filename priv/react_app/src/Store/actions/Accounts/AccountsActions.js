...
export function forgot_password({email}) {
  return dispatch => {
    ...
    return API.session.forgot_password({email})
    .then(res => {
...
export function verify_forgot_password_key({key}) {
  return dispatch => {
    ...
    return API.session.verify_forgot_password_key({key})
    .then(res => {
...
export function replace_forgotten_password({key, password, password_confirmation}) {
  return dispatch => {
