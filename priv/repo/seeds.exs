...
Repo.insert!(%Mailtemplate{name: "Reset Password", subject: "Nexpo | Reset password!", content: "", signature: "<h1>Reset Password!</h1><a href=<%= reset_password_url(@user) %>>Reset</a>"})
Repo.insert!(%Mailtemplate{name: "Hosts Welcome", subject: "Arkad | Welcome Hosts!", content: "", signature: "Best Regards\nhosts.arkad@tlth.se"})
