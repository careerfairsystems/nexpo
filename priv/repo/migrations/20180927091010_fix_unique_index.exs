defmodule Nexpo.Repo.Migrations.FixUniqueIndex do
  ...
  def change do
    ...
    create unique_index(:desired_programme, [:company_id, :programme_id], name: :company_programme_id)

    create unique_index(:student_sessions, [:student_id, :company_id], name: :unique_session_id)
    create unique_index(:student_session_applications, [:student_id, :company_id], name: :unique_session_appl_id)
  end
end
